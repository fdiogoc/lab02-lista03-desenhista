...
class Tela extends JPanel {
    ...
    /**
     * Construtor padrão da classe. Configura algumas opções de cores da tela e
     * atribibutos do pincel.
     * 
     */
    public Tela() {
    ...
    /**
     * Método que escreve informações auxiliares úteis: - Dimensões da tela -
     * Desenho Escolhido
     * 
    ...
    /**
     * Método responsável por desenhar tudo o que irá aparecer na tela. É aqui que
     * os alunos deverão trabalhar. Porém devem evitar de fazerem um código
     * demasiadamente grande, devem separar em métodos auxiliares (subrotinas)
     * sempre que possível.
     * 
    ...
    protected void paintComponent(Graphics g) {
        ...
        switch (desenhoEscolhido) {
            ...
            case "Smiles":
                ...
                break;
            case "Bandeira":
                Desenhos.bandeira(g2d, getSize());
                break;
            case "Predio":
                Desenhos.DesenharPredioCompleto(g2d, getSize());
                break;
            default:
 

                Desenhos.desenhoQuadrado(g2d,50,50,200,25,3);
