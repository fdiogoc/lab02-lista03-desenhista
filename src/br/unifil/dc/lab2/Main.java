...
public class Main extends JFrame {
    ...
    /**
     * O construtor do aplicativo Desenhista. É aqui que todos os elementos da
     * interface gráfica são construídos, configurados e posicionados. Por enquanto,
     * aqui também é feito o tratamento de eventos (input de usuário através de
     * mouse e teclado), utilizando classes anônimas. Provavelmente vamos separar
     * esta funcionalidade no futuro.
     *
    ...
    public Main() {
        ...
        String nomesExercicios[] = { "Desenho Livre", "Asterisco", "Smiles", "Bandeira", "Polígono", "Predio" };
